export const marlData: any[] = [
    ...
    {position: 40, name: 'Fluorine', weight: 18.9984, symbol: 'F'},
    ...
    {position: 50, name: 'Hydrogen', weight: 1.0079, symbol: 'H'},
    ...
    {position: 100, name: 'Fluorine', weight: 12.9984, symbol: 'F'},
];
